...
cmc_host_rrd_config = [
{'id': 'ddeaf80c-c2d3-4150-937c-fb34a847bcb3', 'value': {'rras': [(50.0, 1, 2880), (50.0, 5, 2880), (50.0, 30, 4320), (50.0, 360, 5840)], 'step': 60, 'cfs': ['MIN', 'MAX', 'AVERAGE'], 'format': 'cmc_single'}, 'condition': {}, 'options': {'description': 'Default RRD configuration, using new single RRD format'}},
] + cmc_host_rrd_config
...
{'id': '8e8b9033-b459-4233-90c1-ae79834b4a64', 'value': {'rras': [(50.0, 1, 2880), (50.0, 5, 2880), (50.0, 30, 4320), (50.0, 360, 5840)], 'step': 60, 'cfs': ['MIN', 'MAX', 'AVERAGE'], 'format': 'cmc_single'}, 'condition': {}, 'options': {'description': 'Default RRD configuration, using new single RRD format'}},
] + cmc_service_rrd_config
